...
//       `https://newsapi.org/v2/everything?q=${encodeURIComponent("gold economics OR XAUUSD OR FOREX")}&language=en&sortBy=relevancy&from=2025-04-12&to=2025-05-12&pageSize=5&apiKey=${NEWSAPI_KEY}`  
//     )
    
    
//     if (!res.ok) {
//       console.log(res);
//       throw new Error(`Error: News API responded with status: ${res}`);
//     }
